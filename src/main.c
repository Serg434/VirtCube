...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define A GPIO_PIN_10      // PA10
#define B GPIO_PIN_9       // PA9
#define C GPIO_PIN_8       // PA8
#define D GPIO_PIN_10      // PB10
#define E GPIO_PIN_4       // PB4
#define F GPIO_PIN_3       // PB3
#define G GPIO_PIN_5       // PB5
...
int countDel = 500;
int randNum = 7;
// int randArr[7] = {0, 1, 2, 3, 4, 5, 6};
int ledArr[7] = {A, B, C, D, E, F};
static GPIO_TypeDef *GpioArr[7] = {GPIOA, GPIOA, GPIOA, GPIOB, GPIOB, GPIOB, GPIOB};
uint32_t lastPress;
int sleepTime = 10000;
/* USER CODE END PV */
...
int main(void)
{
  ...
  while (1)
  {
    ...
    if (HAL_GetTick() - lastPress >= sleepTime)
    {
      randNum = 0;
    }
